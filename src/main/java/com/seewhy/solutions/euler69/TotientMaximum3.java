...
import static com.seewhy.solutions.euler97.BigIntegers._2;
...
public class TotientMaximum3 extends AbstractEulerSolver {
    ...
    public BigInteger findMaximum0(BigInteger max, BigInteger prime, BigInteger product, BigInteger lastPrime) {
